  ...
  >
    <div className="audio-lists-panel-header">
      <h2 className="audio-lists-panel-header-title">
        ...
        <span className="audio-lists-panel-header-num">{audioLists.length}</span>
        <span className="audio-lists-panel-header-actions">
          ...
          <span className="audio-lists-panel-header-close-btn" title={locale.closeText} onClick={onCancel}>
    ...
    >
      {audioLists.length >= 1 ? (
        ...
        <>
          ...
          <span className="no-data">{locale.emptyText || locale.notContentText}</span>
        </>
      )}
    </div>
  </div>
